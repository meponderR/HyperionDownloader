...
public class WailsForegroundService extends android.app.Service {
    public static final String ACTION_START = "com.meponder.hyperiondownloader.FGS_START";
    private static final String CHANNEL_ID = "hyperion_fgs_channel";
    private static final int NOTIFICATION_ID = 0x18DEA; // Arbitrary ID for the ongoing notification.

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        String title = "Hyperion Downloader";
