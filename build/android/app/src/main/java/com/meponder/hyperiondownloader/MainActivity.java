package com.meponder.hyperiondownloader;
...
import com.wails.app.WailsBridge;
import com.wails.app.WailsJSBridge;
import com.wails.app.WailsPathHandler;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- ADD THIS HERE TO LISTEN FOR STATUS BAR & NOTCH RECTANGLES ---
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.webview), (v, windowInsets) -> {
            // Get the bounding boxes for status/navigation bars and hardware cutouts
            ...
            // Safe injection script targeting the CSS Variables
            String js = String.format(java.util.Locale.US,
                "if (document && document.documentElement) {" +
                "  var root = document.documentElement;" +
                "  root.style.setProperty('--android-safe-top', '%fpx');" +
                "  root.style.setProperty('--android-safe-left', '%fpx');" +
                "  root.style.setProperty('--android-safe-right', '%fpx');" +
                "  root.style.setProperty('--android-safe-bottom', '%fpx');" +
                "}",
